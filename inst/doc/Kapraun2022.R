...
## ----process_aylward_data, eval = FALSE---------------------------------------
...
## ----cleanup_repeated_aylward_figure, eval = FALSE----------------------------
#  MFdata.main <- NULL
...
## ----aylward_figure_no_fup, eval = FALSE--------------------------------------
...
## ----aylward_analysis_text, eval = FALSE--------------------------------------
#  
...
## ----aylward_figure_with_fup, eval = FALSE------------------------------------
...
## ----dallmann2018_figure, eval = FALSE----------------------------------------
...
## ----curley1969_makepreds, eval = FALSE---------------------------------------
...
## ----curley1969_figure_compounds, eval = FALSE--------------------------------
...
## ----curley1969_figure_tissues, eval = FALSE----------------------------------
...
## ----brain_uncertainty_prop_table, eval = FALSE-------------------------------
...
## ----Rfetmat_uncertainty, eval = FALSE----------------------------------------
...
## ----Rfetbrain_uncertainty, eval = FALSE--------------------------------------
#  
...
## ----Wang_Uncertainty_Propagation, eval = FALSE-------------------------------
#  
...
## ----wang2018_makepreds_nofup, eval = FALSE-----------------------------------
#  
...
## ----brain_uncertainty_prop_table_nofup, eval = FALSE-------------------------
...
## ----Rfetmat_uncertainty_nofup, eval = FALSE----------------------------------
...
## ----Rfetbrain_uncertainty_nofup, eval = FALSE--------------------------------
#  
...
## ----MFratio_allhttk_preds_nofup, eval = FALSE--------------------------------
#  times <- sort(unique(c(seq(13 * 7, 40 * 7, 0.25),seq(278,280,.1))))
#  
...
## ----MFratio_allhttk_figure_nofup, eval = FALSE-------------------------------
...
## ----MFratio_allhttk_stats_nofup, eval = FALSE--------------------------------
